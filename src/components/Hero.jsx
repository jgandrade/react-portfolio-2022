        ...
        <div className='hero'>
            <motion.div variants={headlineContainer} initial='hidden' animate='show' className='hero-name' style={{ overflow: "hidden" }}>
                <div>
                    ...
                    <a href='./Andrade_John_Glenn.pdf' target="_blank"><motion.button
                        initial={
                            {
                                opacity: 0,
                                x: 100,
                    ...
                    >View Resume</motion.button></a>
                </div>
                <a className='go-down' href="#intro-container"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#EEEEEE" className="bi bi-arrow-down-circle" viewBox="0 0 16 16">
